...
function AdminChat({ updateChat, dispatch, CHATS_INPUTS }) {
  ...
  return (
    <div className="w-full md:w-[70%] h-screen mt-32 mx-auto">
      <nav className='bg-rose-700 w-fit h-16 flex flex-row justify-between items-center shadow-lg px-3 py-10'>
