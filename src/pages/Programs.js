...
function Programs() {
  return (
    <div className='w-full h-fit bg-gray-500 overflow-hidden'>
    ...
    <div className='flex flex-row flex-wrap justify-center w-[80%] m-auto'>
      {/* First Row */}
      <div className='flex flex-row flex-wrap  justify-around items-center m-10'>
        <div className='w-96 m-4 px-10 md:px-0'>
      ...
      <div className='flex flex-row-reverse flex-wrap  justify-around items-center m-10'>
        <div className='w-96 m-4 px-10 md:px-0'>
